    ...
    <W as funty::Numeric>::Bytes: bitvec::view::BitView<Store = u8>,
{
    ...
    while result != EvaluationResult::Complete {
        ...
        match result {
            ...
            EvaluationResult::RequiresMemory { address, size, space: None, base_type: UnitOffset(0) } => {
                ...
                let data = device_memory.read_slice(address..address + size as u64)?.ok_or_else(|| TraceError::MissingMemory(address))?;
